...
public class RuleResult {
    ...
    /**
     * Create a result with a single action (simplified for generated code).
     * 
     * @param action Action to execute
     * @return Rule result
     */
    public static RuleResult action(String action) {
        List<String> actions = new ArrayList<>();
        actions.add(action);
        return new RuleResult("generated", actions, true, 0, null);
    }
    
    /**
     * Create a result with no match (simplified for generated code).
     * 
     * @return Rule result
     */
    public static RuleResult noMatch() {
        return new RuleResult("generated", new ArrayList<>(), false, 0, null);
    }
