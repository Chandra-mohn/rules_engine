# Credit Actions Rule Library

This is a generated rule library JAR for rule: **Credit Actions** (ID: `81`)
...
This will create:
- `target/81-rule-1.0.0.jar` - Main library JAR
- `target/81-rule-1.0.0-jar-with-dependencies.jar` - JAR with all dependencies
...
- `src/main/java/.../CreditActionsActionSet.java` - Rule implementation
