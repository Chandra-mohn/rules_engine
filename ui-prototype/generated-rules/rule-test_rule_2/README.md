# ageVerification Rule Library

This is a generated rule library JAR for rule: **ageVerification** (ID: `test_rule_2`)
...
This will create:
- `target/test-rule-2-rule-1.0.0.jar` - Main library JAR
- `target/test-rule-2-rule-1.0.0-jar-with-dependencies.jar` - JAR with all dependencies
...
- `src/main/java/.../Test_Rule_2Rule.java` - Rule implementation
