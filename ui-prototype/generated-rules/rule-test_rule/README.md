# Type Test Rule Rule Library

This is a generated rule library JAR for rule: **Type Test Rule** (ID: `test-rule`)
...
This will create:
- `target/test-rule-rule-1.0.0.jar` - Main library JAR
- `target/test-rule-rule-1.0.0-jar-with-dependencies.jar` - JAR with all dependencies
...
- `src/main/java/.../TypeTestRuleRule.java` - Rule implementation
