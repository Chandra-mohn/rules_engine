# test_error Rule Library

This is a generated rule library JAR for rule: **test_error** (ID: `74`)
...
This will create:
- `target/74-rule-1.0.0.jar` - Main library JAR
- `target/74-rule-1.0.0-jar-with-dependencies.jar` - JAR with all dependencies
...
- `src/main/java/.../TestErrorRule.java` - Rule implementation
