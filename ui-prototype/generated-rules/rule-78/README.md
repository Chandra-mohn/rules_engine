# Credit_Score_Check_1758340635_3455 Rule Library

This is a generated rule library JAR for rule: **Credit_Score_Check_1758340635_3455** (ID: `78`)
...
This will create:
- `target/78-rule-1.0.0.jar` - Main library JAR
- `target/78-rule-1.0.0-jar-with-dependencies.jar` - JAR with all dependencies
...
```java
import com.rules.generated.CreditScoreCheck17583406353455Rule;
import com.rules.context.RuleContext;
import com.rules.runtime.RuleResult;

// Execute the rule
RuleContext context = new RuleContext(jsonData);
RuleResult result = CreditScoreCheck17583406353455Rule.execute(context);
...
- `src/main/java/.../CreditScoreCheck17583406353455Rule.java` - Rule implementation
