# Credit Score Check Rule Library

This is a generated rule library JAR for rule: **Credit Score Check** (ID: `75`)
...
This will create:
- `target/75-rule-1.0.0.jar` - Main library JAR
- `target/75-rule-1.0.0-jar-with-dependencies.jar` - JAR with all dependencies
...
- `src/main/java/.../CreditScoreCheckRule.java` - Rule implementation
