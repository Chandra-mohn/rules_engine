...
/**
 * Generated rule class for: businessDateArithmetic
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:48:17.542175
...
public class BusinessDateArithmeticRule implements Rule {
    
    private static final String RULE_NAME = "businessDateArithmetic";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        if (compareNumbers((evaluateArithmetic(getBusinessDate(), "+", 5.00, "days")), getTodayAtMidnight()) > 0) {
