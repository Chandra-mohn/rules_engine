...
/**
 * Generated rule class for: weekendCheck
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.302847
...
public class WeekendCheckRule implements Rule {
    
    private static final String RULE_NAME = "weekendCheck";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=DateTimeFunction[DAY_OF_WEEK(1)], operator=>=, right=Value[type=NUMBER, value=6]]], then=Action[manualReview]]
        if (compareNumbers(getDayOfWeek(context.getValue("transaction.timestamp")), 6) >= 0) {
