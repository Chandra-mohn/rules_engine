 ...
 * 
 * Generated on: 2025-08-26T09:47:35.686809
...
public class AgeVerificationRule implements Rule {
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=Attribute[applicant.age], operator=<, right=Value[type=NUMBER, value=18]]], then=Action[rejectApplication]]
