...
/**
 * Generated rule class for: performanceTest
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.575087
...
public class PerformanceTestRule implements Rule {
    
    private static final String RULE_NAME = "performanceTest";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=Attribute[applicant.age], operator=>=, right=Value[type=NUMBER, value=18]]], then=Action[approveApplication]]
