...
/**
 * Generated rule class for: testRule2
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.463304
...
public class TestRule2Rule implements Rule {
    
    private static final String RULE_NAME = "testRule2";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=Attribute[transaction.amount], operator=<, right=Value[type=NUMBER, value=100]]], then=Action[approveTransaction]]
        if (compareNumbers(context.getValue("transaction.amount"), 100) < 0) {
