...
/**
 * Generated rule class for: dateArithmetic
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.241428
...
public class DateArithmeticRule implements Rule {
    
    private static final String RULE_NAME = "dateArithmetic";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=ArithmeticExpression[operands=2, operators=1], operator=>, right=DateTimeLiteral[TODAY:TODAY]]], then=Action[conditionalApproval]]
        if (compareNumbers((evaluateArithmetic(context.getValue("applicant.applicationDate"), "+", 30.00, "days")), getTodayAtMidnight()) > 0) {
