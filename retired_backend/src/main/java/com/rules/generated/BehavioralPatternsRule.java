...
/**
 * Generated rule class for: behavioralPatterns
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:35.655908
...
public class BehavioralPatternsRule implements Rule {
    
    private static final String RULE_NAME = "behavioralPatterns";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=AndExpression[operands=2], then=Action[sendAlert]]
        if ((!Objects.equals(context.getValue("transaction.location"), context.getValue("customer.homeLocation")) && compareNumbers(context.getValue("transaction.amount"), context.getValue("customer.travelThreshold")) > 0)) {
            actions.add("sendAlert");
        }
