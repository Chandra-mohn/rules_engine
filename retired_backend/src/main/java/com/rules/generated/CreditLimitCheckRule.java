...
/**
 * Generated rule class for: creditLimitCheck
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:35.520933
...
public class CreditLimitCheckRule implements Rule {
    
    private static final String RULE_NAME = "creditLimitCheck";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=Attribute[transaction.amount], operator=>, right=Attribute[card.availableBalance]]], then=Action[decline]]
