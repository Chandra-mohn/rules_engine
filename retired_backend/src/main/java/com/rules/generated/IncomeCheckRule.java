...
/**
 * Generated rule class for: incomeCheck
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.407024
...
public class IncomeCheckRule implements Rule {
    
    private static final String RULE_NAME = "incomeCheck";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=Attribute[applicant.annualIncome], operator=>=, right=Value[type=NUMBER, value=50000]]], then=Action[approveApplication]]
        if (compareNumbers(context.getValue("applicant.annualIncome"), 50000) >= 0) {
