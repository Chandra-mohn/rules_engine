...
/**
 * Generated rule class for: arithmeticTest
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.784243
...
public class ArithmeticTestRule implements Rule {
    
    private static final String RULE_NAME = "arithmeticTest";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=Attribute[applicant.annualIncome], operator=>, right=MultiplicativeExpression[operands=2, operators=1]]], then=Action[approveApplication]]
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=Attribute[applicant.totalDebt], operator=>, right=MultiplicativeExpression[operands=2, operators=1]]], then=Action[rejectApplication]]
        if (compareNumbers(context.getValue("applicant.totalDebt"), evaluateArithmetic(context.getValue("applicant.annualIncome"), "*", 0.5)) > 0) {
