...
/**
 * Generated rule class for: debtToIncomeCheck
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:35.558550
...
public class DebtToIncomeCheckRule implements Rule {
    
    private static final String RULE_NAME = "debtToIncomeCheck";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=AndExpression[operands=2], then=Action[approveApplication]]
        if ((compareNumbers(context.getValue("applicant.creditScore"), 700) >= 0 && compareNumbers(context.getValue("applicant.annualIncome"), evaluateArithmetic(context.getValue("applicant.requestedCreditLimit"), "*", 3)) > 0)) {
