...
/**
 * Generated rule class for: complexArithmetic
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.867719
...
public class ComplexArithmeticRule implements Rule {
    
    private static final String RULE_NAME = "complexArithmetic";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=ArithmeticExpression[operands=2, operators=1], operator=>, right=Value[type=NUMBER, value=750]]], then=Action[approveApplication]]
        if (compareNumbers((evaluateArithmetic(context.getValue("applicant.score"), "+", context.getValue("applicant.bonus"))), 750) > 0) {
            actions.add("approveApplication");
        }
        
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=MultiplicativeExpression[operands=2, operators=1], operator=>, right=Value[type=NUMBER, value=0.4]]], then=Action[manualReview]]
        if (compareNumbers(evaluateArithmetic(context.getValue("applicant.debt"), "/", context.getValue("applicant.income")), 0.4) > 0) {
            actions.add("manualReview");
        }
