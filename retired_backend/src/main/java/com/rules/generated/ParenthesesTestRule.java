...
/**
 * Generated rule class for: parenthesesTest
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.909002
...
public class ParenthesesTestRule implements Rule {
    
    private static final String RULE_NAME = "parenthesesTest";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=MultiplicativeExpression[operands=2, operators=1], operator=>, right=Value[type=NUMBER, value=1000]]], then=Action[approveApplication]]
        if (compareNumbers(evaluateArithmetic(context.getValue("applicant.base"), "*", (evaluateArithmetic(context.getValue("applicant.multiplier"), "+", 1))), 1000) > 0) {
