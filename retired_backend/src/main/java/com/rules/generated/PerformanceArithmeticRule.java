...
/**
 * Generated rule class for: performanceArithmetic
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.824156
...
public class PerformanceArithmeticRule implements Rule {
    
    private static final String RULE_NAME = "performanceArithmetic";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=MultiplicativeExpression[operands=2, operators=1], operator=>, right=ArithmeticExpression[operands=2, operators=1]]], then=Action[approveApplication]]
        if (compareNumbers(evaluateArithmetic(context.getValue("applicant.income"), "*", 0.3), (evaluateArithmetic(context.getValue("applicant.expenses"), "+", 500))) > 0) {
