...
/**
 * Generated rule class for: testRule1
 * 
 ...
 * 
 * Generated on: 2025-08-26T09:47:34.463222
...
public class TestRule1Rule implements Rule {
    
    private static final String RULE_NAME = "testRule1";
    ...
    public RuleResult execute(RuleContext context) {
        ...
        // Step: Step[condition=NotExpression[negated=false, operand=Comparison[left=Attribute[customer.age], operator=>, right=Value[type=NUMBER, value=21]]], then=Action[approveApplication]]
        if (compareNumbers(context.getValue("customer.age"), 21) > 0) {
