 ...
 * @complexity 1/10
 * @performance hot
 * @timestamp 2025-11-23T03:08:26Z
 */
public class TestCashAdvanceRule {
    ...
    public static RuleResult evaluate(Map<String, Object> context) {
        ...
        // Entity extraction (from DSL entities: transaction)
        Map<String, Object> transaction = (Map<String, Object>) context.get("transaction");

        // Rule logic
        if (_equals(_getFieldValue((Map<String, Object>)transaction, "type"), _getFieldValue(context, "CASH_ADVANCE"))) {
            matched = true;
                actions.add("set_limit(" + "1000" + ")");
        }
